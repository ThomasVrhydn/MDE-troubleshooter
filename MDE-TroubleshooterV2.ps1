...
<Window 
        ...
        Title="MDE troubleshooter" Height="658" Width="905" WindowStyle="ToolWindow" ResizeMode="NoResize" Background="White">

    <Grid  Name="MainWindow1" Width="800" Margin="52,24,53,69">

        <Border BorderBrush="Black" BorderThickness="1" HorizontalAlignment="Left" Height="99" Margin="0,352,0,0" VerticalAlignment="Top" Width="302"/>
        <Border BorderBrush="Black" BorderThickness="1" HorizontalAlignment="Left" Height="111" Margin="506,346,0,0" VerticalAlignment="Top" Width="214"/>

        <Border BorderBrush="Black" BorderThickness="1" HorizontalAlignment="Left" Height="235" Margin="508,44,0,0" VerticalAlignment="Top" Width="212"/>
        ...
        <Button  Name="btnShowSenseLogs" Content="Show Sense logs" HorizontalAlignment="Left" Margin="528,353,0,0" VerticalAlignment="Top" RenderTransformOrigin="0.486,-5.099" Width="178" FontWeight="Bold" Background="#FF707070" BorderBrush="#FF707070"/>
        <Button  Name="btnShowDefenderAVLogs" Content="Show Defender AV logs" HorizontalAlignment="Left" Margin="528,390,0,0" VerticalAlignment="Top" Width="178" FontWeight="Bold" Background="#FF707070" BorderBrush="#FF0E0D0D"/>
        ...
        <Label  Name="lblLastestEngineVersion" Content="MS lastest Engine:" HorizontalAlignment="Left" Margin="7,357,0,0" VerticalAlignment="Top" Height="25" Width="152" FontWeight="Bold"/>
        <Label  Name="lblLastestEngineVersion_txt" Content="N/A Engine Version" HorizontalAlignment="Left" Margin="160,360,0,0" VerticalAlignment="Top" FontStyle="Italic"/>
        <Label  Name="lblLastestPlatformVersion" Content="MS lastest Platform:" HorizontalAlignment="Left" Margin="7,373,0,0" VerticalAlignment="Top" Height="25" Width="152" FontWeight="Bold"/>
        <Label  Name="lblLastestPlatformVersion_txt" Content="N/A Platform Version" HorizontalAlignment="Left" Margin="160,375,0,0" VerticalAlignment="Top" FontStyle="Italic"/>
        <Label  Name="lblLatestSigVersion" Content="MS lastest Signature:" HorizontalAlignment="Left" Margin="7,387,0,0" VerticalAlignment="Top" Height="42" Width="152" FontWeight="Bold"/>
        <Label  Name="lblLatestSigVersion_txt" Content="N/A Signature Version" HorizontalAlignment="Left" Margin="160,389,0,0" VerticalAlignment="Top" FontStyle="Italic"/>
        <Button  Name="btnExclusions" Content="Show Exclusions" HorizontalAlignment="Left" Margin="530,419,0,0" VerticalAlignment="Top" Width="174" FontWeight="Bold" Background="#FF707070" BorderBrush="#FF0E0D0D"/>
        <Button  Name="btnCheckForLastestUpdate" Content="Check for latest Updates" HorizontalAlignment="Left" Margin="111,420,0,0" VerticalAlignment="Top" Width="175" FontWeight="Bold" Background="#FF707070" BorderBrush="#FF101010"/>
        ...
        <Label  Name="lblQuarantine_text" Content="N/A Quarantine" HorizontalAlignment="Left" Margin="160,0,0,0" VerticalAlignment="Center" FontStyle="Italic" Width="120"/>
        ...
        <Button  Name="btnProtectionLogs" Content="Show Microsoft Protection Log" HorizontalAlignment="Left" Margin="522,246,0,0" VerticalAlignment="Top" Width="190" FontWeight="Bold" BorderBrush="#FF0E0D0D" Background="#FF707070" RenderTransformOrigin="0.5,0.5" >
            <Button.RenderTransform>
                <TransformGroup>
                    <ScaleTransform/>
                    <SkewTransform/>
