...
<Window 
        ...
        Title="MDE troubleshooter" Height="500" Width="905" WindowStyle="ToolWindow" ResizeMode="NoResize">
    <Grid Name="MainWindow1" Width="800" Height="434">
           <Border BorderBrush="Black" BorderThickness="1" HorizontalAlignment="Left" Height="99" Margin="0,325,0,0" VerticalAlignment="Top" Width="302"/>
        <Border BorderBrush="Black" BorderThickness="1" HorizontalAlignment="Left" Height="111" Margin="506,267,0,0" VerticalAlignment="Top" Width="214"/>

        <Border BorderBrush="Black" BorderThickness="1" HorizontalAlignment="Left" Height="212" Margin="508,44,0,0" VerticalAlignment="Top" Width="212"/>

        <Border BorderBrush="Black" BorderThickness="1" HorizontalAlignment="Left" Height="272" Margin="0,43,0,0" VerticalAlignment="Top" Width="302"/>
        ...
        <Button Name="btnRunPerformance" Content="Run Performance Analyze" HorizontalAlignment="Left" Margin="528,83,0,0" VerticalAlignment="Top" Width="178" FontWeight="Bold" BorderBrush="#FF0E0D0D" Background="#FF707070"/>
        ...
        <Button Name="btnShowSenseLogs" Content="Show Sense logs" HorizontalAlignment="Left" Margin="528,274,0,0" VerticalAlignment="Top" RenderTransformOrigin="0.486,-5.099" Width="178" FontWeight="Bold" Background="#FF707070" BorderBrush="#FF707070"/>
        <Button Name="btnShowDefenderAVLogs" Content="Show Defender AV logs" HorizontalAlignment="Left" Margin="528,311,0,0" VerticalAlignment="Top" Width="178" FontWeight="Bold" Background="#FF707070" BorderBrush="#FF0E0D0D"/>
        ...
        <Label Name="lblSettings_Copy1" Content="Tooling:" HorizontalAlignment="Left" Margin="523,47,0,0" VerticalAlignment="Top" Height="31" Width="106" FontWeight="Bold" FontSize="16"/>
        <Label Name="lblLastestEngineVersion" Content="MS lastest Engine:" HorizontalAlignment="Left" Margin="7,330,0,0" VerticalAlignment="Top" Height="25" Width="152" FontWeight="Bold"/>
        <Label Name="lblLastestEngineVersion_txt" Content="N/A Engine Version" HorizontalAlignment="Left" Margin="160,333,0,0" VerticalAlignment="Top" FontStyle="Italic"/>
        <Label Name="lblLastestPlatformVersion" Content="MS lastest Platform:" HorizontalAlignment="Left" Margin="7,346,0,0" VerticalAlignment="Top" Height="25" Width="152" FontWeight="Bold"/>
        <Label Name="lblLastestPlatformVersion_txt" Content="N/A Platform Version" HorizontalAlignment="Left" Margin="160,348,0,0" VerticalAlignment="Top" FontStyle="Italic"/>
        <Label Name="lblLatestSigVersion" Content="MS lastest Signature:" HorizontalAlignment="Left" Margin="7,360,0,0" VerticalAlignment="Top" Height="42" Width="152" FontWeight="Bold"/>
        <Label Name="lblLatestSigVersion_txt" Content="N/A Signature Version" HorizontalAlignment="Left" Margin="160,362,0,0" VerticalAlignment="Top" FontStyle="Italic"/>
        <Button Name="btnExclusions" Content="Show Exclusions" HorizontalAlignment="Left" Margin="530,340,0,0" VerticalAlignment="Top" Width="174" FontWeight="Bold" Background="#FF707070" BorderBrush="#FF0E0D0D"/>
        <Button Name="btnCheckForLastestUpdate" Content="Check for latest Updates" HorizontalAlignment="Left" Margin="111,393,0,0" VerticalAlignment="Top" Width="175" FontWeight="Bold" Background="#FF707070" BorderBrush="#FF101010"/>
        ...
        <Label Name="lblQuarantine_text" Content="N/A Quarantine" HorizontalAlignment="Left" Margin="160,206,0,0" VerticalAlignment="Top" FontStyle="Italic" Width="120"/>
        ...
        <Button Name="btnShowASR" Content="Show ASR rules" HorizontalAlignment="Left" Margin="111,279,0,0" VerticalAlignment="Top" Width="175" FontWeight="Bold" Background="#FF707070" BorderBrush="#FF101010"/>
