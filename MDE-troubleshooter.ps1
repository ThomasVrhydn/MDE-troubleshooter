...
This tool will help you with analysing issues with Defender for Endpoint locally on your device. IT will centralize the security configuration, logs files, update
...
Script need to run as admin to view all setttings
...
<Window 
    ...
    <Grid Name="MainWindow1" Width="800" Height="434">
       <Label Name="lblPUAProtect_text" Content="N/A PUAProtect" HorizontalAlignment="Left" Margin="160,231,0,0" VerticalAlignment="Top" FontStyle="Italic" RenderTransformOrigin="0.5,0.5" Width="151">
        ...
        <Label Name="lblLastestEngineVersion" Content="MS lastest Engine:" HorizontalAlignment="Left" Margin="7,320,0,0" VerticalAlignment="Top" Height="25" Width="152" FontWeight="Bold"/>
        <Label Name="lblLastestEngineVersion_txt" Content="N/A Engine Version" HorizontalAlignment="Left" Margin="160,320,0,0" VerticalAlignment="Top" FontStyle="Italic"/>
        <Label Name="lblLastestPlatformVersion" Content="MS lastest Platform:" HorizontalAlignment="Left" Margin="7,336,0,0" VerticalAlignment="Top" Height="25" Width="152" FontWeight="Bold"/>
        <Label Name="lblLastestPlatformVersion_txt" Content="N/A Platform Version" HorizontalAlignment="Left" Margin="160,336,0,0" VerticalAlignment="Top" FontStyle="Italic"/>
        <Label Name="lblLatestSigVersion" Content="MS lastest Signature:" HorizontalAlignment="Left" Margin="7,350,0,0" VerticalAlignment="Top" Height="42" Width="152" FontWeight="Bold"/>
        <Label Name="lblLatestSigVersion_txt" Content="N/A Signature Version" HorizontalAlignment="Left" Margin="160,352,0,0" VerticalAlignment="Top" FontStyle="Italic"/>
